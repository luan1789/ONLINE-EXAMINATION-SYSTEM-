 ...
 * @author PC
 */
@WebServlet(name = "EditQuestionController", urlPatterns = {"/EditQuestionController"})
public class EditQuestionController extends HttpServlet {
    ...
    private static final String SUCCESS = "detail_question.jsp";
    private static final String ERROR = "ad_all_question.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            QuestionDTO ques = dao.getQuestionByID(questionID);
            if (ques != null) {
